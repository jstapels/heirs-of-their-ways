...
Session notes are maintained in `campaign-notes/sessions/` for reference when planning future adventures.

## File Organization

- `campaign-notes/adventures/` - Planned adventures and story arcs
- `campaign-notes/npcs/` - NPC profiles and stat blocks
- `campaign-notes/pcs/` - Player character backgrounds
- `campaign-notes/locations/` - Location descriptions
- `campaign-notes/items/` - Custom magic items
- `campaign-notes/lore/` - World history and background
- `campaign-notes/sessions/` - Session summaries
